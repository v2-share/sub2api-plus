...
describe('Prompt Audit components', () => {
  ...
  it('supports group search, stale configured groups, nine scanners, and bounded worker inputs', async () => {
    const draft: PromptAuditDraft = {
      enabled: true, blocking_enabled: false, store_pass_events: false, engine_mode: 'qwen3guard', system_prompt: 'default-system-prompt', effective_mode: 'async_audit', strategy: 'priority',
