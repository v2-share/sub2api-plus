...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/v2-share/sub2api-plus/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/v2-share/sub2api-plus/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/v2-share/sub2api-plus/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/v2-share/sub2api-plus/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
